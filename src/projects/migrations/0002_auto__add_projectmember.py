...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_projectmember', (
            ...
            ('role', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'projects', ['ProjectMember'])


    def backwards(self, orm):
        # Deleting model 'ProjectMember'
        db.delete_table(u'projects_projectmember')
