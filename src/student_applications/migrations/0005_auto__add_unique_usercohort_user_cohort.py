...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserCohort', fields ['user', 'cohort']
        db.create_unique(u'student_applications_usercohort', ['user_id', 'cohort_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserCohort', fields ['user', 'cohort']
        db.delete_unique(u'student_applications_usercohort', ['user_id', 'cohort_id'])
