...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.registration_ends_at'
        db.add_column(u'events_event', 'registration_ends_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.registration_ends_at'
        db.delete_column(u'events_event', 'registration_ends_at')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'registration_ends_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'events.eventinvitation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'bhzqyqhdborkubgeiwfqqmlevwpudfomkccqvfuq'", 'max_length': '50'}),
