...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventInvitation.attendance'
        db.add_column(u'events_eventinvitation', 'attendance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventInvitation.attendance'
        db.delete_column(u'events_eventinvitation', 'attendance')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'registration_ends_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'starts_at': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '400'})
        },
        u'events.eventinvitation': {
            'Meta': {'ordering': "['event', 'status', 'created_at']", 'unique_together': "(('event', 'user'),)", 'object_name': 'EventInvitation'},
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invitations'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'sddzjscebrogjacnozfdbyweblaxuanjokygmodd'", 'max_length': '50'}),
