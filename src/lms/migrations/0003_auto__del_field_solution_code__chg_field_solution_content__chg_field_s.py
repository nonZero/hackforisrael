...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lms_solution', 'content', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Solution.content_html'
        db.alter_column(u'lms_solution', 'content_html', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Solution.code'
        raise RuntimeError("Cannot reverse this migration. 'Solution.code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Solution.code'
        ...
        # Changing field 'Solution.content_html'
        db.alter_column(u'lms_solution', 'content_html', self.gf('django.db.models.fields.TextField')(null=True))
